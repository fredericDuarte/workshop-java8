...
//        
//        if(julesOpt.filter(adult).map(p->p.getAge()).isPresent())
//        {
//            if(julesOpt.get().getAge().equals(30)) throw new GoodException();
//        }
//        
        // or
        
       julesOpt.filter(adult).map(p->p.getAge()).ifPresent(age -> { age = 30; throw new GoodException();});
