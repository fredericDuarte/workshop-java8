...
// or alternative 	
		...
		res = Stream.iterate(1L, i -> i + 1).limit(n).mapToLong(Long::longValue).reduce(0, (i, c) -> i + c);

		return res;
	}

	// exécuter le test pour vérifier que les méthodes imperativeSum et
